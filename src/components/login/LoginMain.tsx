  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md mx-4 z-10">
        ...
        >
          {/* Linha azul no topo */}
          <div className="h-0.75 w-full" style={{ background: "var(--color-blue)" }} />
          ...
          <div className="px-8 py-10">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              >
                Nex<span style={{ color: "var(--color-white)" }}>Play</span>
              </span>
              <p
            ...
            {expiredByInactivity && (
              ...
              >
                Sessão encerrada por <strong>30 dias de inatividade</strong>.
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <p className="text-[11px] text-center -mt-1" style={{ color: "var(--color-gray)" }}>
                Sessões expiram após{" "}
                <span style={{ color: "var(--color-blue)" }}>30 dias de inatividade</span>.
              </p>
              ...
              <button
                ...
                style={{
                  background: loading ? "rgba(121,196,242,0.25)" : "var(--color-blue)",
              ...
              >
                {loading ? (
                  <span className="flex items-center justify-center gap-2">
                    <CircularProgress size={15} sx={{ color: "var(--color-black)" }} />
                    Entrando...
                  </span>
                ) : (
                  "Entrar"
            ...
            <p className="mt-6 text-center text-xs" style={{ color: "var(--color-gray)" }}>
              Problemas de acesso?{" "}
              <a
